...
#define OPT3001_INT_CONFIG      0xC400
...
void InitLightInterrupt() {
    // Master Configuration
    I2C_initMaster               (EUSCI_B1_BASE, &i2cConfig);
    I2C_setSlaveAddress          (EUSCI_B1_BASE, OPT3001_SLAVE_ADDRESS);
    I2C_enableModule             (EUSCI_B1_BASE);

    // Select OPT3001_P_CONFIG register
    I2C_setMode                  (EUSCI_B1_BASE, EUSCI_B_I2C_TRANSMIT_MODE);
    while (I2C_isBusBusy(EUSCI_B1_BASE));
    I2C_masterSendMultiByteStart (EUSCI_B1_BASE, OPT3001_P_CONFIG);
    I2C_masterSendMultiByteNext  (EUSCI_B1_BASE, (OPT3001_INT_CONFIG >> 8));
    I2C_masterSendMultiByteFinish(EUSCI_B1_BASE, (OPT3001_INT_CONFIG & 0xFF));

    // Select OPT3001_P_HIGH register
    while (I2C_isBusBusy(EUSCI_B1_BASE));
    I2C_masterSendMultiByteStart (EUSCI_B1_BASE, OPT3001_P_HIGH);
    I2C_masterSendMultiByteNext  (EUSCI_B1_BASE, (OPT3001_HIGH_THRESHOLD >> 8));
    I2C_masterSendMultiByteFinish(EUSCI_B1_BASE, (OPT3001_HIGH_THRESHOLD & 0xFF));

    // Select OPT3001_P_LOW register
    while (I2C_isBusBusy(EUSCI_B1_BASE));
    I2C_masterSendMultiByteStart (EUSCI_B1_BASE, OPT3001_P_LOW);
    I2C_masterSendMultiByteNext  (EUSCI_B1_BASE, (OPT3001_LOW_THRESHOLD >> 8));
    I2C_masterSendMultiByteFinish(EUSCI_B1_BASE, (OPT3001_LOW_THRESHOLD & 0xFF));
}
...
unsigned ReadLight() {
    ...
    while (I2C_isBusBusy(EUSCI_B1_BASE));
    I2C_masterSendMultiByteStart (EUSCI_B1_BASE, OPT3001_P_CONFIG);
    I2C_masterSendMultiByteNext  (EUSCI_B1_BASE, (OPT3001_DEFAULT_CONFIG >> 8));
    I2C_masterSendMultiByteFinish(EUSCI_B1_BASE, (OPT3001_DEFAULT_CONFIG & 0xFF));
    ...
    // Select OPT3001_P_RESULT register
    while (I2C_isBusBusy(EUSCI_B1_BASE));
    I2C_setMode                  (EUSCI_B1_BASE, EUSCI_B_I2C_TRANSMIT_MODE);
    I2C_masterSendSingleByte     (EUSCI_B1_BASE, OPT3001_P_RESULT);
